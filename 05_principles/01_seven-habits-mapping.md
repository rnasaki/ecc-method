...
|---|---|---|---|
| 1 | Be Proactive (主体的である) | 承認最小化・自己起点で走る・障害は自分から取り除く | [50_permissions/](../50_permissions/), [27_user-care/03_blocker-removal.md](../27_user-care/03_blocker-removal.md) |
...
- ユーザーが感情的になっても受け身にならず、阻害要因を即除去 ([27_user-care/03_blocker-removal.md](../27_user-care/03_blocker-removal.md))
